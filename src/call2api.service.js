  ...
  angular
      ...
      .factory('call2ApiSrv', [
        ...
        function($q, $http, $location, $window, configSrv, cultureSrv, httpSrv, paramsSrv, sessionSrv) {
           ...
           */
          function extendSignParams(_params, priorityParams) {
            return angular.extend({}, priorityParams, sessionSrv.getSessionParameter(), _params);
          }
          ...
          function makeSignCall(_method, _path, _params, _data, type) {
            ...
            if(_params.hasOwnProperty('_method')) {
              priorityParams._method = _params._method;
              delete _params._method;
            }
            configSrv.getKeyValue('SrvUrl').then(function(_base){
              httpSrv.request({
                method: _method,
                url: _base + _path,
                params: extendSignParams(_params, priorityParams),
                data: _data,
                responseType: type
              }).then(function(data){
          ...
          self.makeDirectSignCall = makeDirectSignCall;
           ...
           * @return {promise}        Promise
           */
          self.makePostCall = function(_path, _params, _data, type) {
            return makeDirectSignCall('POST', _path, _params, _data, type);
          };
